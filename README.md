...
```sh
git clone https://github.com/jogide/MAFIA-USERBOT.git
cd MAFIA-USERBOT
...
Poject [MAFIABOT](https://github.com/jogide/MafiaBotOP) is free software: you can redistribute it and/or modify
